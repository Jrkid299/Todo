...
var $author$project$Todo$initialModel = {details: '', loggedIn: false, task: ''};
...
var $author$project$Todo$SaveDetails = function (a) {
	return {$: 'SaveDetails', a: a};
};
var $author$project$Todo$SaveTask = function (a) {
	return {$: 'SaveTask', a: a};
};
var $author$project$Todo$Signup = {$: 'Signup'};
...
var $author$project$Todo$styledButton = A2(
...
var $author$project$Todo$styledDetails = A2(
	$rtfeldman$elm_css$Html$Styled$styled,
...
var $author$project$Todo$styledForm = A2(
	$rtfeldman$elm_css$Html$Styled$styled,
...
var $author$project$Todo$styledInput = A2(
	$rtfeldman$elm_css$Html$Styled$styled,
	$rtfeldman$elm_css$Html$Styled$input,
	_List_fromArray(
		[
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2(
				$author$project$Todo$styledForm,
				_List_Nil,
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								A2(
								$author$project$Todo$styledInput,
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$Attributes$id('task'),
										$rtfeldman$elm_css$Html$Styled$Attributes$type_('text'),
										$rtfeldman$elm_css$Html$Styled$Events$onInput($author$project$Todo$SaveTask)
									]),
								_List_Nil)
							])),
						A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$text('Details')
									])),
								A2(
								$author$project$Todo$styledDetails,
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$Attributes$id('details'),
										$rtfeldman$elm_css$Html$Styled$Attributes$type_('details'),
										$rtfeldman$elm_css$Html$Styled$Events$onInput($author$project$Todo$SaveDetails)
									]),
								_List_Nil)
							])),
						A2(
						...
						_List_fromArray(
							[
								A2(
								$author$project$Todo$styledButton,
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$Attributes$type_('submit'),
										$rtfeldman$elm_css$Html$Styled$Events$onClick($author$project$Todo$Signup)
									]),
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$text('Add Todo')
									]))
							]))
					]))
			]));
...
var $author$project$Todo$main = $elm$browser$Browser$sandbox(
	{
		init: $author$project$Todo$initialModel,
		update: $author$project$Todo$update,
		view: A2($elm$core$Basics$composeR, $author$project$Todo$view, $rtfeldman$elm_css$Html$Styled$toUnstyled)
	});
